...
function getWeather(cityCoordinates){
    ...
    function getCityLatLon() {
        ...
        var geoAPICall = apiRootUrl + "/geo/1.0/direct?q=" + searchedCity + "&limit=5&appid=" + apiKey;
        fetch(geoAPICall)
    ...
    function populateTodayWeather(currentWeather){
        ...
        var conditionsImg = docuemnt.getElementById("conditons");
      ...
      cardText[3].textContent = "Humidity: " + dailyWeather[i +1].humidity + "%";
        ...
        function createHistoryButtons(){
            ...
            for (var i = 0; i < searchHistory.length; i++){
                var createHistoryButtons = document.createElement("button");
